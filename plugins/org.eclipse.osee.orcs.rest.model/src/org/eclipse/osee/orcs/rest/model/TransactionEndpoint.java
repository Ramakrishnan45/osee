...
public interface TransactionEndpoint {
   ...
   Response replaceWithBaselineTxVersion(@PathParam("user") String userId, @PathParam("branch-id") BranchId branchId, @PathParam("tx-id") TransactionId txId, @PathParam("art-id") Long artId, String comment);
}